@extends('admin.include.master') 
	@section('title') New Logo - ফরিদপুর পৌরসভাs @endsection 
@section('content')
        ...
        <div class="layout-content-body">
        	<div class="col-sm-12">
                <div class="page-header">
                    <h3 class="page-title">Create New Logo</h3>
                        <ol class="breadcrumb">
                            <li><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li>Settings</li>
                            <li class="active">New Logo</li>
                            <li style="text-align:right; float:right">
                            	<a  href="{{ route('logo.index') }}" style="color:#fff;"><i class="fa fa-list"></i> View Logo List</a>
                            </li>
                        </ol>
                </div>
