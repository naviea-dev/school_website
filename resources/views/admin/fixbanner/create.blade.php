@extends('admin.include.master') 
	@section('title') New Banner - ফরিদপুর পৌরসভাs @endsection 
@section('content')
                    ...
                    <h3 class="page-title">Create New Banner</h3>
                        <ol class="breadcrumb">
                            ...
                            <li style="text-align:right; float:right">
                            	<a  href="{{ route('fixbanner.index') }}" style="color:#fff;"><i class="fa fa-list"></i> View Banner List</a>
                            </li>
                        </ol>
                </div>
                  ...
                  <div class="card">
                      ...
                      <div class="row" style="margin:10px">
                      	<div class="col-sm-offset-2">
                            <form method="POST" action="{{ route('fixbanner.store') }}" enctype="multipart/form-data">
                        @csrf
